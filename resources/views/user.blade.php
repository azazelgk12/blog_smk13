...
<!-- styles -->
<link rel="stylesheet" href="{{URL::asset('css1/fancybox/jquery.fancybox.css')}}">
<link href="{{URL::asset('css1/bootstrap.css')}}" rel="stylesheet" />
<link href="{{URL::asset('css1/bootstrap-theme.css')}}" rel="stylesheet" />
<link rel="stylesheet" href="{{URL::asset('css1/slippry.css')}}"/>
<link href="{{URL::asset('css1/style.css')}}" rel="stylesheet" />
<link rel="stylesheet" href="{{URL::asset('css1/default.css')}}"/ >
...
<section id="intro">
			<ul id="slippry-slider">
			  <li>
				<a href="#slide1"><img src="{{URL::asset('img1/slide/1.jpg')}}" alt="Welcome to Groovin!"></a>
			  </li>
			  <li>
				<a href="#slide2"><img src="{{URL::asset('img1/slide/2.jpg')}}"  alt="This is an awesome bootstrap template"></a>
			  </li>
			  <li>
				<a href="#slide3"><img src="{{URL::asset('img1/slide/3.jpg')}}" alt="Check it out, you are going to <span class='red'>♥</span> it :)"></a>
			  </li>
			</ul>
</section>
<!-- end intro -->
		...
		<div class="col-md-3">
			...
			<div class="roles">
				...
				<ul class="social-profile">
					...
					<li><a href="#"><i class="fa-heart"></i></a></li>
				</ul>
			</div>
			</div>
		</div>
...
<!-- javascript -->
<script src="{{URL::asset('js1/modernizr.custom.js')}}"></script>
<script src="{{URL::asset('js1/jquery-1.9.1.min.js')}}"></script>
<script src="{{URL::asset('js1/jquery.easing.js')}}"></script>
<script src="{{URL::asset('js1/classie.js')}}"></script>
<script src="{{URL::asset('js1/bootstrap.js')}}"></script>
<script src="{{URL::asset('js1/slippry.min.js')}}"></script>
<script src="{{URL::asset('js1/nagging-menu.js')}}"></script>
<script src="{{URL::asset('js1/jquery.nav.js')}}"></script>
<script src="{{URL::asset('js1/jquery.scrollTo.js')}}"></script>
<script src="{{URL::asset('js1/jquery.fancybox.pack.js')}}"></script> 
<script src="{{URL::asset('js1/jquery.fancybox-media.js')}}"></script> 
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyASm3CwaK9qtcZEWYa-iQwHaGi3gcosAJc&sensor=false')}}"></script>
<script src="{{URL::asset('js1/masonry.pkgd.min.js')}}"></script>
<script src="{{URL::asset('js1/imagesloaded.js')}}"></script>
<script src="{{URL::asset('js1/jquery.nicescroll.min.js')}}"></script>
<script src="{{URL::asset('js1/validate.js')}}"></script>	
<script src="{{URL::asset('js1/AnimOnScroll.js')}}"></script>
    <script>
...
<script src="{{URL::asset('js1/custom.js')}}"></script>
